...
public class GuardarUsuarioController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Recibir parametros del POST
        String nombre = request.getParameter("nombre");
        String apellido = request.getParameter("apellido");
        int idCiudad = Integer.parseInt(request.getParameter("ciudad"));
        
        // Traer el objeto ciudad de la ciudad que selecciono el usuario
        Ciudad ciudad = Ciudad.buscar(idCiudad);
        // Agregar al ArrayList el usuario nuevo
